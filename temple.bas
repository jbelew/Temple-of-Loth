...
370 PRINT"            ÜÜÜÜÜ ÜÜÜÜ Ü   Ü ÜÜÜÜ  Ü    ÜÜÜÜ           ÜÜÜ   ÜÜÜÜ
380 PRINT"              Û   Û    ÛÛ ÛÛ Û   Û Û    Û             Û   Û  Û
390 PRINT"              Û   Û฿฿  Û Û Û Û฿฿฿  Û    Û฿฿           Û   Û  Û฿฿
400 PRINT"              Û   ÛÜÜÜ Û   Û Û     ÛÜÜÜ ÛÜÜÜ          ฿ÜÜÜ฿  Û
410 PRINT:
420 PRINT
430 PRINT"                  Ü     ÜÜÜ  ÜÜÜÜÜ  Ü  Ü            ÜÜÜÜÜÜ
440 PRINT"                  Û    Û   Û   Û    Û  Û          Ü฿ Û  Û ฿Ü
450 PRINT"                  Û    Û   Û   Û    Û฿฿Û        Ü฿   Û  Û   ฿Ü
460 PRINT"                  ÛÜÜÜ ฿ÜÜÜ฿   Û    Û  Û      ÜÛÜÜÜÜÜÛÜÜÛÜÜÜÜÜÛÜ
...
11190 LPRINT
11200 LPRINT "ฮ = empty room      B = book            C = chest"
11210 LPRINT "D = stairs down     ๏ = entrance/exit    = flares"
11220 LPRINT "G = gold pieces      = monster         ่ = crystal orb"
11230 LPRINT "P = magic pool      S = sinkhole        T = treasure"
11240 LPRINT "U = stairs up       * = Drow            Û = warp/amulet
11250 LPRINT
11260 LPRINT
